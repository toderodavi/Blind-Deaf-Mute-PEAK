    ...
    internal class ToggleBDM
    {
        ...
        public static void CreateToggle()
        {
            if (modToggle == null)
            {
                ...
                modToggle.transform.SetParent(BoardingPassUIManager.BoardingPassPanelObject.transform, false);
                ...
                toggle.onValueChanged.AddListener(BoardingPassUIManager.ShowModLayout);
            }
        }
    }
}
